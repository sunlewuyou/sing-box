...
func main() {
	...
	newContent, updated0 := findAndReplace(objectsMap, projectContent, []string{"tk.dcedu.tangdou"}, newVersion.VersionString())
	newContent, updated1 := findAndReplace(objectsMap, newContent, []string{"tk.dcedu.tangdou.independent", "tk.dcedu.tangdou.system"}, newVersion.String())
